...
use qubit_cas::constants::CONTENTION_BACKOFF_INITIAL_DELAY;
use qubit_cas::constants::CONTENTION_BACKOFF_JITTER_FACTOR;
use qubit_cas::constants::CONTENTION_BACKOFF_MAX_ATTEMPTS;
use qubit_cas::constants::CONTENTION_BACKOFF_MAX_DELAY;
...
fn test_cas_constants_match_strategy_budgets() {
    ...
    assert_eq!(CONTENTION_BACKOFF_MAX_ATTEMPTS, 64);
    assert_eq!(CONTENTION_BACKOFF_INITIAL_DELAY, Duration::from_micros(50));
    assert_eq!(CONTENTION_BACKOFF_MAX_DELAY, Duration::from_millis(5));
    assert_eq!(CONTENTION_BACKOFF_MAX_ELAPSED, Duration::from_millis(50));
    assert_eq!(CONTENTION_BACKOFF_MAX_TOTAL_ELAPSED, Duration::from_millis(250));
    assert_eq!(CONTENTION_BACKOFF_JITTER_FACTOR, 0.25);
...
fn test_total_elapsed_budgets_exceed_operation_budgets() {
    ...
    assert!(CONTENTION_BACKOFF_MAX_TOTAL_ELAPSED > CONTENTION_BACKOFF_MAX_ELAPSED);
